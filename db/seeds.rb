...
Checkout.create(user_id:7, game_id:5, rating:8, comment:"feels good to keep shooting", checkout_date: (DateTime.now - 2.day), return_date: (DateTime.now - 1.day))
Checkout.create(user_id:9, game_id:7, rating:8, comment:"so much fun to play with family.", checkout_date: (DateTime.now - 2.day), return_date: (DateTime.now - 1.day))
Checkout.create(user_id:3, game_id:8, rating:7, comment:"fight was intense.", checkout_date: (DateTime.now - 2.day), return_date: (DateTime.now - 1.day))
Checkout.create(user_id:5, game_id:9, rating:6, comment:"freedom is mine", checkout_date: (DateTime.now - 2.day), return_date: (DateTime.now - 1.day))bo
Checkout.create(user_id:2, game_id:4, rating:4, comment:"it is cool", checkout_date: (DateTime.now - 2.day), return_date: (DateTime.now - 1.day))
Checkout.create(user_id:2, game_id:1, rating:8, comment:"ball is life", checkout_date: (DateTime.now - 2.day), return_date: (DateTime.now - 1.day))
Checkout.create(user_id:1, game_id:2, rating:8, comment:"player looks so real", checkout_date: (DateTime.now - 2.day), return_date: (DateTime.now - 1.day))
